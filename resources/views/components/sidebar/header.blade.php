<div class="flex items-center justify-between flex-shrink-0 px-3">
    ...
    <a href="{{ route('admin-dashboard') }}" class="inline-flex items-center gap-2">
        <x-app-logo-back aria-hidden="true" class="w-10 h-auto" />

        <span class="sr-only">Skydelis</span>
    </a>

    <!-- Toggle button -->
    <x-button type="button" icon-only sr-text="Toggle sidebar" variant="neutral" x-show="isSidebarOpen || isSidebarHovered"
